...
class Plugin_fitsin(models.Model):
	...
	psffwhmmin = models.DecimalField(max_digits = 16,decimal_places = 3,null=True,blank=True,help_text="Minimum PSF FWHM (based on a 2D Moffat fit) [arcsec]")
	psffwhm = models.DecimalField(max_digits = 16,decimal_places = 3,null=True,blank=True,help_text="Average PSF FWHM (based on a 2D Moffat fit) [arcsec]")
	psffwhmmax = models.DecimalField(max_digits = 16,decimal_places = 3,null=True,blank=True,help_text="Maximum PSF FWHM (based on a 2D Moffat fit) [arcsec]")
